...
export const filterAffairs = (affairs: AffairType[], filter: FilterType): any => { // need to fix any
    ...
    switch (filter){
        case "high": return affairsCopy = affairs.filter(el => el.priority === filter);
        case "middle": return affairsCopy = affairs.filter(el => el.priority === filter);
        case "low": return affairsCopy = affairs.filter(el => el.priority === filter);
    }
    return affairsCopy // need to fix
}
export const deleteAffair = (affairs: AffairType[], _id: number): any => { // need to fix any
    console.log(affairs, _id)

    let copy = affairs.filter(el => el._id !== _id)
    console.log(copy)
